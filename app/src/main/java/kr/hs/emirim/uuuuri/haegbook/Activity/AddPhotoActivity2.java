    ...
    private void initialize() {
        ...
        findViewById(R.id.done_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AddPhotoActivity2.this, TravelDetailActivity.class);
...
//                startActivityForResult(Intent.createChooser(intent, "Please Select Image"), IMAGE_REQUEST_CODE);
    ...
    public void UploadImageFileToFirebaseStorage() {
        ...
        if (FilePathUri != null) {
            ...
            storageReference2nd.putFile(FilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            FirebaseImage imageUploadInfo = new FirebaseImage(TempImageName, taskSnapshot.getDownloadUrl().toString(), "2017.11.10");
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(AddPhotoActivity2.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toast.makeText(AddPhotoActivity2.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
